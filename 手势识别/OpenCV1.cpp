...
//
//BIG5 TRANS ALLOWED
#include "C:\Users\Thinkpad\Desktop/opencv1/opencv/stdafx.h"
#include "windows.h"
...
#endif
#include "C:\Users\Thinkpad\Desktop/opencv1/opencv//include//CameraApi.h"
...
void hand_YCrCb()
{
	//转换到YCrBr色彩模式，Y:明亮度，描述灰阶值 Cr：反映输入信号红色部分与亮度值的差异 
        //色调 Cb:饱和度
	cvCvtColor(src2, img_YCrCb, CV_RGB2YCrCb);


	//分割到Y,Cr,Cb
	cvSplit(img_YCrCb, Y_channel, Cr_channel, Cb_channel, 0);//信道分离，0表示最后第四个信道不存在，置0
